...
const page = async() => {
  ...
  return (
    ...
    <div className="mx-auto w-fit sm:w-[500px] h-[400px] flex flex-col gap-2  rounded justify-around shadow-md border-2 bg-white dark:bg-black p-10 items-center mt-20">
